...
# 2.x Plot the mean yields by year
```{r, fig.cap= Strawberry yield in CWT/acre with standard deviation error bars. The number below each bar indicates the sample size represented in the bar. }
shiny_bar("Year")
```
